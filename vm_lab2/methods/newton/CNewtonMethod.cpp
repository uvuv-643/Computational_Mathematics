...
enum MethodResult CNewtonMethod::validateBorder(CFunction* function_data, float border_left, float border_right) {
...
CNewtonResult CNewtonMethod::performMethod(CFunction* function_data, float initial_border_left, float initial_border_right, float eps) {
