...
enum MethodResult CSecantMethod::validateBorder(CFunction* function_data, float border_left, float border_right) {
...
CSecantResult CSecantMethod::performMethod(CFunction* function_data, float initial_border_left, float initial_border_right, float eps) {
